                ...
                <section className="xl:container mt-10 pb-10 w-full">
                  <div className="px-2 md:px-0">
                    <div className=" bg-white border px-5 rounded-xl shadow tracking-widest md:px-20 md:py-10">
                      <div className="flex">
                        <button className={`text-xl ${subSection === "about" ? "bg-[#F1F5F9] border-b-4" : "bg-white "}    uppercase font-semibold rounded-t-md border-green-500 px-3 py-2 my-3`} onClick={() => setSubSection("about")}>
                          About Tour
                        </button>
                        {
                          plan.itenary &&
                          <button className={`text-xl ${subSection === "itinerary" ? "bg-[#F1F5F9] border-b-4" : "bg-white"}  uppercase font-semibold  border-green-500 rounded-t-md px-3 py-2 my-3`} onClick={() => setSubSection("itinerary")}>Tour Itinerary</button>
                        }
                      </div>
                      {
                        subSection === "about" && <div dangerouslySetInnerHTML={{ __html: plan.disp }} className="text-lg text-justify text-slate-600"></div>
                      }
                      {
                        (plan.itenary && subSection === "itinerary") && <div dangerouslySetInnerHTML={{ __html: plan.itenary }} className="text-lg  text-justify text-slate-700"></div>
                      }
