...
const Hero1 = () => {
  return (
    <div className='xl:container mt-32 px-[1rem] md:px-[3rem] overflow-hidden'>
    <div className='flex flex-col md:flex-row   items-center justify-between gap-6'>
       ...
       <div className='md:grid   md:grid-cols-2 flex flex-row flex-nowrap overflow-scroll gap-6'>
